...
public class AuthController {
    ...
    public String signInForm(UsersDTO usersDTO){
    ...
    public String signUpForm(UsersDTO usersDTO){   // ModelAttribute 자동으로 값들을 받아오고 넣어주고 하는 어노테이션
        //DTO --> entity 객체
        Users users = Users.authSignUp(usersDTO, passwordEncoder);
        authService.saveUser(users);  // 유저 저장
        System.out.println("AuthController.signup");
        System.out.println("users = " + users); //  작성한 값들을 콘솔로 확인
