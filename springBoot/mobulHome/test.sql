use foxy;
use homestudy;
use testmobul;boards

insert into users(user_id, role, user_password) values ("유저", "ADMIN", "11");
...
create database testmobul;
use testMobul;
create database mobul;
...
INSERT INTO users(user_id, user_password, user_phone)
VALUES 
('user1', 'password1', '010-1111-1111'),
('user2', 'password2', '010-2222-2222'),
('user3', 'password3', '010-3333-3333'),
('user4', 'password4', '010-4444-4444');
